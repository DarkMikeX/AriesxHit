...
(function () {
  ...
  function updateBypassUI(enabled) {
    ...
    if (container) {
      if (enabled) {
        container.style.borderColor = 'rgba(96, 165, 250, 0.6)';
        container.style.boxShadow = '0 10px 36px rgba(96, 165, 250, 0.3)';
      } else {
        container.style.borderColor = 'rgba(220, 38, 38, 0.6)';
        container.style.boxShadow = '0 10px 36px rgba(220, 38, 38, 0.3)';
      }
    }
  }
