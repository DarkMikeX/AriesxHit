...
(function () {
  ...
  function updateBypassUI(enabled) {
    ...
    if (container) {
      if (enabled) {
        container.style.borderColor = 'rgba(34, 211, 238, 0.4)';
        container.style.boxShadow = '0 0 16px rgba(34, 211, 238, 0.2)';
      } else {
        container.style.borderColor = 'rgba(248, 113, 113, 0.4)';
        container.style.boxShadow = '0 0 16px rgba(248, 113, 113, 0.2)';
      }
    }
  }
